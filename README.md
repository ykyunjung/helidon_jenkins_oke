...
```
docker build -t helidon-movie-api-mp .
```

## Start the application with Docker

```
docker run --rm -p 8080:8080 helidon-movie-api-mp:latest
```
...
kubectl get service helidon-movie-api-mp  # Verify deployed service
```
# helidon_jenkins_oke
